...
#define NUMBER_OF_WHEELS 5

// ---------- Matrix Kinematic ---------- //
float m_kinematic[5][3] = {
    {-0.000000f, 1.666667f, 1.666667f},
    {-1.585094f, 0.515028f, 1.666667f},
    {-0.979642f, -1.348362f, 1.666667f},
    {0.979642f, -1.348362f, 1.666667f},
    {1.585094f, 0.515028f, 1.666667f}
};
// ---------- Matrix Odometry ---------- //
float m_odometry[2][5] = {
    {0.000000f, -0.228254f, -0.141068f, 0.141068f, 0.228254f},
    {0.240000f, 0.074164f, -0.194164f, -0.194164f, 0.074164f}
};
...
void odometry2(int N, float* T, float angle_robot, float output[2], float heading_offset) {
  float gain = 0.48;  // ini g ada di papernya, cuma setelah dicoba kayaknya butuh
  float x = 0;
  float y = 0;
