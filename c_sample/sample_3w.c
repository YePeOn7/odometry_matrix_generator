...
// ---------- Matrix Kinematic ---------- //
float m_kinematic[3][3] = {
    {-0.000000f, 1.666667f, 1.666667f},
    {-1.443376f, -0.833333f, 1.666667f},
    {1.443376f, -0.833333f, 1.666667f}};
// ---------- Matrix Odometry ---------- //
float m_odometry[2][3] = {
    {0.000000f, -0.346410f, 0.346410f},
    {0.400000f, -0.200000f, -0.200000f}};

void transformKinematic(float x, float y, float w, const float m_kinematic[NUMBER_OF_WHEELS][3], float output[4]) {
